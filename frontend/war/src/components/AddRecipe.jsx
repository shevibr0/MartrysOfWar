...
const AddRecipe = () => {
    ...
    return (
        <div className="bg-gray-200">
            ...
            <h2 className="flex justify-center text-3xl font-bold">הוספת מתכון</h2>
            {error && <p style={{ color: 'red' }}>{error}</p>}
            <div className='flex flex-wrap justify-center items-center bg-gray-400 text-white h-screen'>
                <form onSubmit={handleSubmit} className="flex flex-col space-y-4 p-8  border-2 border-black">
                    ...
                    <label className="flex flex-col">
                        ...
                        <input
                            ...
                            className="bg-white text-white border border-gray-600 px-4 py-2 rounded"
                        />
                    </label>
                    <label className="flex flex-col">
